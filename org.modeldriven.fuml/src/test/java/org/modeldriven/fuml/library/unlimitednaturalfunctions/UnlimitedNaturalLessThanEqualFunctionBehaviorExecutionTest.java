...
public class UnlimitedNaturalLessThanEqualFunctionBehaviorExecutionTest extends LibraryTest {
	
	@Override
	public void setUp() {
		super.setUp();
		obj = new UnlimitedNaturalLessThanEqualFunctionBehaviorExecution();
	}
	
	/**
	 * Tests the doBody() method in the UnlimitedNaturalLessThanEqualFunctionBehaviorExecution
	 * 
	 * @throws Exception
	 */
...
//	}	
	...
	/**
	 * Tests the new_() method in the UnlimitedNaturalLessThanEqualFunctionBehaviorExecution
	 * class
	 * 
	 * @throws Exception
	 */
	public void testNew_() throws Exception {
		UnlimitedNaturalLessThanEqualFunctionBehaviorExecution newobj = (UnlimitedNaturalLessThanEqualFunctionBehaviorExecution) obj.new_();
